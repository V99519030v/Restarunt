  ...
  getApi = async () => {
    ...
    const dishQuantityAdd = data[0].table_menu_list.map(each => ({
      category_dishes: each.category_dishes.map(cate => ({
        ...cate,
        // dishId: cate.dish_id,
        // dishName: cate.dish_name,
        // dishPrice: cate.dish_price,
        // dishImage: cate.dish_image,
        // dishCurrency: cate.dish_currency,
        // dishCalories: cate.dish_calories,
        // dishDescription: cate.dish_description,
        // dishAvailability: cate.dish_Availability,
        // dishType: cate.dish_Type,
        // addonCat: cate.addonCat,
        dish_quantity: '0',
      })),
